...
$data modify storage color_match:temp all.build.pixel_data.data.color set value "$(current_pixel_color)"
$data modify storage color_match:temp all.build.pixel_data.background set from storage color_match:temp all.build.palette_map.$(current_pixel_color)
data modify storage color_match:temp all.build.pixel_data.data.decimal_color set from storage color_match:temp all.build.pixel_data.background
